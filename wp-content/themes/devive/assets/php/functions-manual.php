...
function dashboard_navas()
{
	...
	Caso precise de ajuda, disponibilizamos um manual sobre o funcionamento do painel de controle, basta clicar no botão <b>manual</b> logo abaixo. <br>
	Se tiver algum problema técnico, entre em contato clicando no botão <b>ajuda</b> ou se preferir envie um e-mail para <b>navas@navas.design</b>.
	</p>
	<a href="' . site_url() . '/manual" class="btManual">Manual</a>
	<a href="https://api.whatsapp.com/send?phone=554196569810&" target="_blank" class="btAjuda">Ajuda</a>
	';
}
function wordpress_destaque()
{
	echo "<a target='_blank' href='http://navas.design'><img width='100%' src='" . get_template_directory_uri() . "/assets/img/home_page_dashboard.svg' /></a>";
}
function add_dashboard_widgets()
{
	wp_add_dashboard_widget('dashboard_suporte_widget', 'Suporte', 'dashboard_navas');
	wp_add_dashboard_widget('dashboard_obvio_widget', 'navas.design', 'wordpress_destaque');
}
